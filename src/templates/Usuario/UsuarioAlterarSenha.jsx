  ...
  return (
    <div className="d-flex">
      ...
      <div className="p-3 w-100">
        <Header goto={"/home"} title={"*** Alterar a Senha ***"} logo={logo} />
        <section className="m-1 p-1 shadow-lg">
          ...
          >
            <>
              ...
              <div className="mb-2">
                <label htmlFor="senha" className="form-label mb-0 fw-bold">
                  Nova Senha:
                </label>
                <input
                  type="password"
              ...
              <div>
                <label htmlFor="newpass" className="form-label mb-0 fw-bold">
                  Confirme a Senha:
                </label>
                <input
                  type="password"
          ...
          {message && (
            <div className="m-1 ">
              <div
                className={
                  "text-center h5 fst-italic py-1 rounded-2 text-dark bg-opacity-25 " +
