...
import UsuarioNovoAdmin from "../templates/Usuario/UsuarioNovoAdmin";
  ...
  return (
    <div>
      <Routes>
        ...
        <Route
          path="/usuarioalterarsenha/:id"
          element={<UsuarioAlterarSenha />}
        />
        <Route path="/usuarionovoadmin" element={<UsuarioNovoAdmin />} />
